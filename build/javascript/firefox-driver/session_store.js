...
bot.dom.getClientRect = function(a) {
  function b(a) {
    ...
    if(c) {
      var d = parseFloat(c[1]), e = parseFloat(c[2]), r = parseFloat(c[3]), k = parseFloat(c[4]), p = parseFloat(c[5]), c = parseFloat(c[6]), n = f.left + f.width, m = f.top + f.height, s = f.left * d, d = n * d, t = f.left * e, e = n * e, u = f.top * r, r = m * r, v = f.top * k, n = m * k, m = s + u + p, k = t + v + c, u = d + u + p, v = e + v + c, s = s + r + p, t = t + n + c, p = d + r + p, c = e + n + c;
...
Utils.keyEvent = function(a, b, c, d, e, f, g, h, l, q) {
  ...
  var r = a.createEvent("KeyEvents");
  r.initKeyEvent(c, !0, !0, a.defaultView, f, h, g, l, d, e);
  q && r.preventDefault();
  return a.defaultView.QueryInterface(Components.interfaces.nsIInterfaceRequestor).getInterface(Components.interfaces.nsIDOMWindowUtils).dispatchDOMEventViaPresShell(b, r, !0)
};
