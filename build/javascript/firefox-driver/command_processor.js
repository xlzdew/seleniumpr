...
goog.string.compareVersions = function(a, b) {
  for(var c = 0, d = goog.string.trim(String(a)).split("."), e = goog.string.trim(String(b)).split("."), f = Math.max(d.length, e.length), g = 0;0 == c && g < f;g++) {
    var h = d[g] || "", k = e[g] || "", r = /(\d*)(\D*)/g, p = /(\d*)(\D*)/g;
    do {
      var l = r.exec(h) || ["", "", ""], q = p.exec(k) || ["", "", ""];
      if(0 == l[0].length && 0 == q[0].length) {
        break
      }
      var c = 0 == l[1].length ? 0 : parseInt(l[1], 10), n = 0 == q[1].length ? 0 : parseInt(q[1], 10), c = goog.string.compareElements_(c, n) || goog.string.compareElements_(0 == l[2].length, 0 == q[2].length) || goog.string.compareElements_(l[2], q[2])
    }while(0 == c)
  }
  return c
};
...
ImpatientListener.prototype.onProgressChange = function(a) {
  ...
  fxdriver.logging.info("readyState is " + a);
...
function buildHandler(a, b, c) {
  ...
  fxdriver.logging.warning("Unsupported page loading strategy: " + d);
  return new PatientListener(a, b, c)
}
...
goog.math.longestCommonSubsequence = function(a, b, c, d) {
  ...
  for(var r = [], h = e, k = f;0 < h && 0 < k;) {
    c(a[h - 1], b[k - 1]) ? (r.unshift(d(h - 1, k - 1)), h--, k--) : g[h - 1][k] > g[h][k - 1] ? h-- : k--
  }
  return r
};
...
wgxpath.Step.Axis = {ANCESTOR:wgxpath.Step.createAxis_("ancestor", function(a, b) {
  ...
  for(var g = 1, h = f.length;g < h;g++) {
    ...
    for(var r = 0, p = k.length;r < p;r++) {
      b = k[r], wgxpath.Node.attrMatches(b, c, d) && a.matches(b) && e.add(b), e = wgxpath.Node.getDescendantNodes(a, b, c, d, e)
    }
  }
  return e
...
bot.dom.getOverflowState = function(a, b) {
  ...
  for(var f = bot.dom.getClientRegion(a, b), g = goog.dom.getOwnerDocument(a), h = g.documentElement, k = g.body, r = bot.dom.getEffectiveStyle(h, "overflow"), p, l = c(a);l;l = c(l)) {
    var q = d(l);
    if("visible" != q.x || "visible" != q.y) {
      ...
      if(m && "hidden" == q.x || s && "hidden" == q.y) {
        return bot.dom.OverflowState.HIDDEN
      }
      if(m && "visible" != q.x || s && "visible" != q.y) {
        m = e(l);
        s = f.bottom < n.top - m.y;
        if(f.right < n.left - m.x && "visible" != q.x || s && "visible" != q.x) {
          return bot.dom.OverflowState.HIDDEN
        }
      ...
      if(m && "visible" != q.x || n && "visible" != q.y) {
        if(p && (q = e(l), f.left >= h.scrollWidth - q.x || f.right >= h.scrollHeight - q.y)) {
          return bot.dom.OverflowState.HIDDEN
        }
        f = bot.dom.getOverflowState(l);
        return f == bot.dom.OverflowState.HIDDEN ? bot.dom.OverflowState.HIDDEN : bot.dom.OverflowState.SCROLL
...
bot.dom.getClientRect = function(a) {
  function b(a) {
    ...
    if(c) {
      var d = parseFloat(c[1]), e = parseFloat(c[2]), p = parseFloat(c[3]), l = parseFloat(c[4]), q = parseFloat(c[5]), c = parseFloat(c[6]), n = f.left + f.width, m = f.top + f.height, s = f.left * d, d = n * d, t = f.left * e, e = n * e, u = f.top * p, p = m * p, v = f.top * l, n = m * l, m = s + u + q, l = t + v + c, u = d + u + q, v = e + v + c, s = s + p + q, t = t + n + c, q = d + p + q, c = e + n + c;
...
bot.dom.appendVisibleTextLinesFromElement_ = function(a, b) {
  if(bot.dom.isElement(a, goog.dom.TagName.BR)) {
    ...
    var h = bot.dom.isShown(a), k = null, r = null;
    h && (k = bot.dom.getEffectiveStyle(a, "white-space"), r = bot.dom.getEffectiveStyle(a, "text-transform"));
    goog.array.forEach(a.childNodes, function(a) {
      a.nodeType == goog.dom.NodeType.TEXT && h ? bot.dom.appendVisibleTextLinesFromTextNode_(a, b, k, r) : bot.dom.isElement(a) && bot.dom.appendVisibleTextLinesFromElement_(a, b)
    });
    f = goog.array.peek(b) || "";
...
Utils.type = function(a, b, c, d, e, f, g) {
  ...
  var h = Utils.getNativeKeyboard(), k = Utils.getNodeForNativeEvents(b), r = Components.classes["@mozilla.org/thread-manager;1"];
  if(d && h && k && r) {
    ...
    for(var r = c.toUpperCase(), p = 0;p < c.length;p++) {
      ...
      if("\ue000" == l) {
        ...
        "\ue008" == l ? (m = Components.interfaces.nsIDOMKeyEvent.DOM_VK_SHIFT, q = (h = !h) ? "keydown" : "keyup") : "\ue009" == l ? (m = Components.interfaces.nsIDOMKeyEvent.DOM_VK_CONTROL, q = (e = !e) ? "keydown" : "keyup") : "\ue00a" == l ? (m = Components.interfaces.nsIDOMKeyEvent.DOM_VK_ALT, q = (k = !k) ? "keydown" : "keyup") : "\ue03d" == l ? (m = Components.interfaces.nsIDOMKeyEvent.DOM_VK_META, q = (d = !d) ? "keydown" : "keyup") : "\ue00b" == l ? m = Components.interfaces.nsIDOMKeyEvent.DOM_VK_PAUSE : 
        ...
        if(q) {
          ...
          s = Utils.keyEvent(a, b, "keydown", m, 0, e, q || h, k, d, !1);
          Utils.keyEvent(a, b, "keypress", l, n, e, q || h, k, d, !s);
          Utils.keyEvent(a, b, "keyup", m, 0, e, q || h, k, d, !1);
          q && !h && (l = Components.interfaces.nsIDOMKeyEvent.DOM_VK_SHIFT, Utils.keyEvent(a, b, "keyup", l, 0, e, !1, k, d, !1))
        }
      }
    }
...
Utils.keyEvent = function(a, b, c, d, e, f, g, h, k, r) {
  if(!goog.dom.getAncestor(b, function(a) {
    return a === b.ownerDocument.documentElement
  }, !0)) {
    return!1
  }
  var p = a.createEvent("KeyEvents");
  p.initKeyEvent(c, !0, !0, a.defaultView, f, h, g, k, d, e);
  r && p.preventDefault();
  return a.defaultView.QueryInterface(Components.interfaces.nsIInterfaceRequestor).getInterface(Components.interfaces.nsIDOMWindowUtils).dispatchDOMEventViaPresShell(b, p, !0)
};
...
bot.events.TouchEventFactory_.prototype.create = function(a, b) {
  ...
  var f = goog.dom.getOwnerDocument(a), g = goog.dom.getWindow(f), h = e(b.changedTouches), k = b.touches == b.changedTouches ? h : e(b.touches), r = b.targetTouches == b.changedTouches ? h : e(b.targetTouches), p;
  bot.events.BROKEN_TOUCH_API_ ? (p = f.createEvent("MouseEvents"), p.initMouseEvent(this.type_, this.bubbles_, this.cancelable_, g, 1, 0, 0, b.clientX, b.clientY, b.ctrlKey, b.altKey, b.shiftKey, b.metaKey, 0, b.relatedTarget), p.touches = k, p.targetTouches = r, p.changedTouches = h, p.scale = b.scale, p.rotation = b.rotation) : (p = f.createEvent("TouchEvent"), goog.userAgent.product.ANDROID ? p.initTouchEvent(k, r, h, this.type_, g, 0, 0, b.clientX, b.clientY, b.ctrlKey, b.altKey, b.shiftKey, 
  b.metaKey) : p.initTouchEvent(this.type_, this.bubbles_, this.cancelable_, g, 1, 0, 0, b.clientX, b.clientY, b.ctrlKey, b.altKey, b.shiftKey, b.metaKey, k, r, h, b.scale, b.rotation), p.relatedTarget = b.relatedTarget);
  return p
};
...
FirefoxDriver.prototype.get = function(a, b) {
  ...
  try {
    ...
    if(d = f.QueryInterface(Components.interfaces.nsIException), "NS_ERROR_MALFORMED_URI" == d.name) {
      fxdriver.logging.warning(d.name);
  ...
  e || (fxdriver.logging.info("No load event expected"), a.send())
};
...
function injectAndExecuteScript(a, b, c, d) {
  ...
  if(e.designMode && "on" == e.designMode.toLowerCase()) {
    ...
    var k = a.session.getWindow(), k = k.wrappedJSObject, r = new Components.utils.Sandbox(k);
    r.window = k;
    r.document = e.wrappedJSObject ? e.wrappedJSObject : e;
    r.navigator = k.navigator;
    r.__webdriverParams = h;
    try {
      var p = Components.utils.evalInSandbox("with(window) { var __webdriverFunc = function(){" + b.script + "};  __webdriverFunc.apply(null, __webdriverParams); }", r);
  ...
  var q = this, n = function() {
    q.modalOpen || a.sendError(new WebDriverError(bot.ErrorCode.JAVASCRIPT_ERROR, "waiting for evaluate.js load failed"))
  }, m = function() {
    ...
    var l = function(b) {
      ...
      q.modalOpen || (a.value = Utils.wrapResult(f.__webdriver_evaluate.result, e), a.status = f.__webdriver_evaluate.code, bot.userAgent.isProductVersion(23) || delete f.__webdriver_evaluate, a.send())
    };
    e.addEventListener("webdriver-evaluate-response", l, !0);
    b = e.createEvent("Events");
    b.initEvent("webdriver-evaluate", !1, !0);
    e.dispatchEvent(b)
  };
  d.runWhenTrue(function() {
    ...
    d.runWhenTrue(m, s, 1E4, n)
  }, 1E4, function() {
    q.modalOpen || a.sendError(new WebDriverError(bot.ErrorCode.JAVASCRIPT_ERROR, "waiting for doc.body failed"))
  })
}
...
FirefoxDriver.prototype.findElementInternal_ = function(a, b, c, d, e) {
  ...
  try {
    ...
    var r = a.session.getImplicitWait();
    if(0 == r || goog.now() - e > r) {
...
FirefoxDriver.prototype.addCookie = function(a, b) {
  ...
  if(!c.domain) {
    e = a.session.getBrowser().contentWindow.location, c.domain = e.hostname
  }else {
...
FirefoxDriver.prototype.dismissAlert = function(a) {
  ...
  fxdriver.modals.isModalPresent(function(c) {
    c ? fxdriver.modals.dismissAlert(b) : (a.status = bot.ErrorCode.NO_MODAL_DIALOG_OPEN, a.value = {message:"No alert is present"});
    a.send()
  }, this.alertTimeout)
};
FirefoxDriver.prototype.acceptAlert = function(a) {
  var b = this;
  fxdriver.modals.isModalPresent(function(c) {
    c ? fxdriver.modals.acceptAlert(b) : (a.status = bot.ErrorCode.NO_MODAL_DIALOG_OPEN, a.value = {message:"No alert is present"});
    a.send()
  }, this.alertTimeout)
};
...
FirefoxDriver.prototype.setAlertValue = function(a, b) {
  fxdriver.modals.isModalPresent(function(c) {
    c ? fxdriver.modals.setValue(b.text) : (a.status = bot.ErrorCode.NO_MODAL_DIALOG_OPEN, a.value = {message:"No alert is present"});
    a.send()
  }, this.alertTimeout)
};
...
FirefoxDriver.prototype.mouseMoveTo = function(a, b) {
  ...
  if(this.enableNativeEvents) {
    a: {
      c = this.jsTimer;
      fxdriver.logging.info("Calling native move with: " + d.x + ", " + d.y);
      var e = null, f;
      ...
      var g;
      try {
        var d = f, h = a.session.getTopWindow(), k = bot.window.getScroll(h), r = goog.math.Coordinate.sum(k, d);
        bot.window.scrollIntoView(r, h);
        var p = bot.window.getScroll(h);
        g = goog.math.Coordinate.difference(r, p)
      }catch(l) {
      ...
      var r = (d = a.session.isMousePressed()) ? f : g, k = Utils.getBrowserSpecificOffset(a.session.getBrowser()), h = r.x + k.x, r = r.y + k.y, p = Utils.getNativeMouse(), q = Utils.getNodeForNativeEvents(e);
      if(p && q) {
        var n = a.session.getMousePosition(), m = n.x + k.x, k = n.y + k.y;
        fxdriver.logging.info("Moving from (" + n.x + ", " + n.y + ") to (" + g.x + ", " + g.y + ")");
        p.mouseMove(q, m, k, h, r);
        ...
        throw generateErrorForNativeEvents(!0, p, q);
      }
    }
    a.send()
  }else {
    g = d.auxiliary || c, fxdriver.logging.info("Calling move with: " + d.x + ", " + d.y + ", " + g), g = this.mouse.move(g, d.x, d.y), this.sendResponseFromSyntheticMouse_(g, a)
  }
};
...
bot.action.drag = function(a, b, c, d, e, f) {
  ...
  for(var h = 1;h <= d;h++) {
    var k = Math.floor(h * b / d), r = Math.floor(h * c / d), p = bot.dom.getClientRect(a), k = new goog.math.Coordinate(e.x + g.left + k - p.left, e.y + g.top + r - p.top);
    f.move(a, k)
  }
  f.releaseButton()
};
...
var WebElement = {elementEquals:function(a, b) {
  ...
  if(!r && this.enableNativeEvents && e && f && h && k) {
    ...
    p = p.y + l;
    try {
      var q = a.session.getMousePosition(), n = new goog.math.Coordinate(h, p), m = Utils.getBrowserSpecificOffset(a.session.getBrowser());
      e.mouseMove(f, q.x + m.x, q.y + m.y, n.x + m.x, n.y + m.y);
...
fxdriver.proxy.configure = function(a) {
  try {
    ...
    fxdriver.logging.info("Unable to configure proxy " + b)
  }
};
...
wdSession.prototype.setWaitForPageLoad = function(a) {
  ...
  fxdriver.logging.info("setWaitForPageLoad " + a)
};
      ...
      if(g = k.fxdriver) {
        if(k.getBrowser().contentWindow) {
          if(g.modalOpen && "getAlertText" != c.name && "setAlertValue" != c.name && "acceptAlert" != c.name && "dismissAlert" != c.name) {
            ...
            "function" != typeof g[c.name] && "function" != typeof WebElement[c.name] ? (d.sendError(new WebDriverError(bot.ErrorCode.UNKNOWN_COMMAND, "Unrecognised command: " + c.name)), fxdriver.logging.error("Unknown command: " + c.name)) : ("get" == c.name && d.session.setWaitForPageLoad(!1), d.startCommand(k), (new DelayedCommand(g, c, d)).execute(0))
          }
        }else {
...
nsCommandProcessor.prototype.newSession = function(a, b) {
  ...
  if(d) {
    ...
    a.session = d;
    a.sessionId = d.getId();
    fxdriver.logging.info("Created a new session with id: " + d.getId());
