...
Utils.keyEvent = function(a, b, c, d, e, f, g, h, l, r) {
  ...
  var q = a.createEvent("KeyEvents");
  q.initKeyEvent(c, !0, !0, a.defaultView, f, h, g, l, d, e);
  r && q.preventDefault();
  return a.defaultView.QueryInterface(Components.interfaces.nsIInterfaceRequestor).getInterface(Components.interfaces.nsIDOMWindowUtils).dispatchDOMEventViaPresShell(b, q, !0)
};
...
bot.events.TouchEventFactory_.prototype.create = function(a, b) {
  ...
  var f = goog.dom.getOwnerDocument(a), g = goog.dom.getWindow(f), h = e(b.changedTouches), l = b.touches == b.changedTouches ? h : e(b.touches), r = b.targetTouches == b.changedTouches ? h : e(b.targetTouches), q;
  bot.events.BROKEN_TOUCH_API_ ? (q = f.createEvent("MouseEvents"), q.initMouseEvent(this.type_, this.bubbles_, this.cancelable_, g, 1, 0, 0, b.clientX, b.clientY, b.ctrlKey, b.altKey, b.shiftKey, b.metaKey, 0, b.relatedTarget), q.touches = l, q.targetTouches = r, q.changedTouches = h, q.scale = b.scale, q.rotation = b.rotation) : (q = f.createEvent("TouchEvent"), goog.userAgent.product.ANDROID ? q.initTouchEvent(l, r, h, this.type_, g, 0, 0, b.clientX, b.clientY, b.ctrlKey, b.altKey, b.shiftKey, 
  b.metaKey) : q.initTouchEvent(this.type_, this.bubbles_, this.cancelable_, g, 1, 0, 0, b.clientX, b.clientY, b.ctrlKey, b.altKey, b.shiftKey, b.metaKey, l, r, h, b.scale, b.rotation), q.relatedTarget = b.relatedTarget);
  return q
};
...
bot.action.drag = function(a, b, c, d, e, f) {
  ...
  for(var h = 1;h <= d;h++) {
    var l = Math.floor(h * b / d), r = Math.floor(h * c / d), q = bot.dom.getClientRect(a), l = new goog.math.Coordinate(e.x + g.left + l - q.left, e.y + g.top + r - q.top);
    f.move(a, l)
  }
  f.releaseButton()
};
