...
goog.string.compareVersions = function(a, b) {
  for(var c = 0, d = goog.string.trim(String(a)).split("."), e = goog.string.trim(String(b)).split("."), f = Math.max(d.length, e.length), g = 0;0 == c && g < f;g++) {
    var h = d[g] || "", l = e[g] || "", r = /(\d*)(\D*)/g, p = /(\d*)(\D*)/g;
    do {
...
bot.dom.getClientRect = function(a) {
  function b(a) {
    ...
    if(c) {
      var d = parseFloat(c[1]), e = parseFloat(c[2]), p = parseFloat(c[3]), k = parseFloat(c[4]), q = parseFloat(c[5]), c = parseFloat(c[6]), n = f.left + f.width, m = f.top + f.height, s = f.left * d, d = n * d, t = f.left * e, e = n * e, u = f.top * p, p = m * p, v = f.top * k, n = m * k, m = s + u + q, k = t + v + c, u = d + u + q, v = e + v + c, s = s + p + q, t = t + n + c, q = d + p + q, c = e + n + c;
...
Utils.keyEvent = function(a, b, c, d, e, f, g, h, l, r) {
  ...
  p.initKeyEvent(c, !0, !0, a.defaultView, f, h, g, l, d, e);
  r && p.preventDefault();
...
Dispatcher.prototype.init_ = function() {
  ...
  this.bind_("/session/:sessionId/frame/parent").on(Request.Method.POST, Dispatcher.executeAs("switchToParentFrame"));
  ...
  this.bind_("/session/:sessionId/moveto").on(Request.Method.POST, Dispatcher.executeAs("mouseMoveTo"));
  this.bind_("/session/:sessionId/buttondown").on(Request.Method.POST, Dispatcher.executeAs("mouseButtonDown"));
  this.bind_("/session/:sessionId/buttonup").on(Request.Method.POST, Dispatcher.executeAs("mouseButtonUp"));
...
function injectAndExecuteScript(a, b, c, d) {
  ...
  if(e.designMode && "on" == e.designMode.toLowerCase()) {
    ...
    var l = a.session.getWindow(), l = l.wrappedJSObject, r = new Components.utils.Sandbox(l);
    r.window = l;
    r.document = e.wrappedJSObject ? e.wrappedJSObject : e;
    r.navigator = l.navigator;
...
FirefoxDriver.prototype.mouseMoveTo = function(a, b) {
  ...
  if(this.enableNativeEvents) {
    a: {
      ...
      var g;
      try {
        var d = f, h = a.session.getTopWindow(), l = bot.window.getScroll(h), r = goog.math.Coordinate.sum(l, d);
      ...
      var r = (d = a.session.isMousePressed()) ? f : g, l = Utils.getBrowserSpecificOffset(a.session.getBrowser()), h = r.x + l.x, r = r.y + l.y, p = Utils.getNativeMouse(), q = Utils.getNodeForNativeEvents(e);
      if(p && q) {
        var n = a.session.getMousePosition(), m = n.x + l.x, l = n.y + l.y;
        fxdriver.logging.info("Moving from (" + n.x + ", " + n.y + ") to (" + g.x + ", " + g.y + ")");
        p.mouseMove(q, m, l, h, r);
