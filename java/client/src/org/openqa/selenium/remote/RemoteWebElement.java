...
public class RemoteWebElement implements WebElement, FindsByLinkText, FindsById, FindsByName,
  ...
  public void sendKeys(CharSequence... keysToSend) {
    ...
    /*else if(keysToSend.toString().contains("remote")){
    	System.out.println("send remote command");
    	 //execute(DriverCommand.SEND_KEYS_TO_ELEMENT, ImmutableMap.of("id", id, "value", ));
    	return;
    }*/
